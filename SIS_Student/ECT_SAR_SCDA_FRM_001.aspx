<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SCDA_FRM_001.aspx.cs" Inherits="SIS_Student.ECT_SAR_SCDA_FRM_001" MasterPageFile="~/Student.Master"%>
                            ...
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SCDA-FRM.001</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p style="text-align: center; font-size: 23px; font-weight: bold;">Internship Request Form<br />
                                          نموذج طلب تدريب عملي
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td>
                                            <p style="text-align: left; font-size: 23px; font-weight: bold;">
                                                <u>Terms & Conditions:</u></p>
                                        </td>
                                        <td>
                                             <p style="text-align: right; font-size: 23px; font-weight: bold;direction: rtl;">
                                                <u>الأحكام والشروط</u></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <ul style="text-align: left;">
                                                <li>The Student should be serious in finding internship place.</li>
                                                <li>ECT has the right to accept or decline the request depending on the situation.</li>
                                                <li>Undergraduates’ internship will be 100 hours or two weeks whichever matches.</li>
                                                <li>Graduates Internship period lasts for maximum two months upon availability.</li>
                                                <li>ECT doesn’t guarantee the hiring in the companies or institutions.</li>
                                            </ul>
                                        </td>
                                        <td>
                                             <ul style="text-align: right; direction: rtl;font-size:13px;">
                                                <li>يجب أن يكون الطالب جادًا في إيجاد مكان للتدريب</li>
                                                <li>كلية الإمارات للتكنولوجيا لها الحق في قبول أو رفض الطلب ، حسب الحالة</li>
                                                <li>التدريب الجامعي سيكون 100 ساعة أو أسبوعين ، أيهما مطابق</li>
                                                <li>تستمر فترة تدريب الخريجين لمدة أقصاها شهرين ، حسب التوافر</li>
                                                <li>لا تضمن كلية الإمارات للتكنولوجيا التوظيف في الشركات أو المؤسسات</li>
                                            </ul>
                                        </td>
                                    </tr>
