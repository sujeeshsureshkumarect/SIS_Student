<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SREG_FRM_023.aspx.cs" Inherits="SIS_Student.ECT_SAR_SREG_FRM_023" MasterPageFile="~/Student.Master" %>
                            ...
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <th style="text-align: right;">Revision Date: 29/01/2018</th>
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SREG-FRM.023</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                ...
                                <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">
                                    <tr>
                                        <td align="center" style="background-color: #f2f2f2;" colspan="2">
                                            <b>Notes</b>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="center"  colspan="2">
                                           1. The cash voucher from the Accounts should be attached with the application.
                                        </td>                                        
                                        <td align="center" >
                                            يجب أن ترفق فاتورة من الحسابات مع استمارة الطلب
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"  colspan="2">
                                            2. Receiving the requested Certificate/Transcript will be after one week from the application date.
                                        </td>
                                       
                                        <td align="center" >
                                            الاستلام بعد اسبوع من تاريخ تقديم الطلب
                                        </td>
                                    </tr>
                                </table>
