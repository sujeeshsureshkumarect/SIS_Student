...
{
    public partial class ECT_SAR_SREG_FRM_001 : System.Web.UI.Page
    {
        ...
        protected void lnk_Generate_Click(object sender, EventArgs e)
        {
            if (drp_Course.SelectedItem.Value != "---Select a Major---")
            {
                ...
                Session["cancelpage"] = "ECT_SAR_SREG_FRM_001.aspx?ServiceID="+ lbl_ServiceID.Text + "";
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Current Major:</b> " + lbl_CurrentMajor.Text + "<br/><b>New Requested Major:</b> " + drp_Course.SelectedItem.Text + "<br/><b>Reason(s) for Changing the Major:</b> " + txt_Remarks.Text.Trim() + "<br/>";
