...
{
    public partial class ECT_SAR_SARO_FRM_010 : System.Web.UI.Page
    {
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Major:</b> "+lbl_CurrentMajor.Text+"<br/><b>Course Title:</b> " + drp_Course.SelectedItem.Text + "<br/><b>Course Code:</b> " + lbl_CourseCode.Text + "<br/><b>Instructor’s Name:</b> " + lbl_Instructor.Text + "<br/><b>Instructor’s Email:</b> "+lbl_InstructorEmail.Text+ "<br/><b>Company Information</b><br/><b>Company Name:</b> "+txt_CompanyName.Text.Trim()+"<br/><b>Address:</b> "+txt_Address.Text.Trim()+"<br/><b>Project Title:</b> "+txt_ProjectTitle.Text.Trim()+"<br/><b>Project Duration:</b> "+ Dates +"<br/><b>Remarks/Notes:</b> " + txt_Remarks.Text.Trim() + "<br/>" + languageoption + "<br/>";
