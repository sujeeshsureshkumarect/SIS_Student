...
namespace SIS_Student
{
    public partial class ECT_SAR_SREG_FRM_008 : System.Web.UI.Page
    {
        ...
        protected void lnk_Generate_Click(object sender, EventArgs e)
        {
            ...
            dr["Year"] = iYear;
            dr["Semester"] = iSem;
            dr["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Financial Status:</b> Balance: AED " + lbl_Balance.Text + "<br/>";
