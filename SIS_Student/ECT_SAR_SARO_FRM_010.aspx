<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SARO_FRM_010.aspx.cs" Inherits="SIS_Student.ECT_SAR_SARO_FRM_010" MasterPageFile="~/Student.Master"%>
                        ...
                        <div class="x_content">
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <th style="text-align: left; padding-left: 10px">Issue: 27/03/2014</th>
                                        <th style="text-align: right;">Revision Date: 10/06/2015</th>
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SARO-FRM.010</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p style="text-align: center; font-size: 23px; font-weight: bold;">Student Project Letter Request<br />
                                            طلب رسالة مشروع تخرج
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <hr />
                                   ...
                                   <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">
                                    ...
                                    <tr>
                                        <td align="center" style="background-color: #f2f2f2;">
                                            <b>Project Title<span style="color: red">*</span></b>
                                        </td>
                                        <td align="center">
                                            <asp:TextBox ID="txt_ProjectTitle" runat="server" CssClass="form-control"></asp:TextBox>
                                             <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="*Project Title Required" ControlToValidate="txt_ProjectTitle" ForeColor="Red" ValidationGroup="no">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                        <td align="center" style="background-color: #f2f2f2;">
                                            <b><span style="color: red">*</span>عنوان المشروع</b>
                                        </td>
                                    </tr>
                                          <tr>
                                        <td align="center" style="background-color: #f2f2f2;">
                                            <b>Project Duration<span style="color: red">*</span></b>
                                        </td>
                                       <td >
                                        ...
                                        <td align="center" style="background-color: #f2f2f2;">
                                            <b><span style="color: red">*</span>مدة المشروع</b>
                                        </td>
                                    </tr>
                                </table>
                                <hr />
