...
{
    public partial class ECT_ACAF_LC_FRM_001 : System.Web.UI.Page
    {
        ...
        public void sentdatatoSPLIst()
        {
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/> <b>Service Description:</b> IESOL Exam Confirmation and Declaration (تأكيد وتوضيح خاص بإختبار اللغة الإنجليزية ايسول)<br/><b>Exam Date:</b> "+DateTime.Now.ToString("dd/MM/yyyy hh:mm tt")+"<br/><b>Emirates ID Number:</b> "+ lbl_EmiratesID.Text + "<br/>"+ languageoption + "<br/>";
