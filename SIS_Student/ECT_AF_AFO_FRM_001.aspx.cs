...
namespace SIS_Student
{
    public partial class ECT_AF_AFO_FRM_001 : System.Web.UI.Page
    {
        ...
        protected void lnk_Generate_Click(object sender, EventArgs e)
        {
            ...
            dr["Year"] = iYear;
            dr["Semester"] = iSem;
            dr["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Service Description:</b> " + hdf_ServiceDescEn.Value + "<br/>";
