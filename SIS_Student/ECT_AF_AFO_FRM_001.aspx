<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_AF_AFO_FRM_001.aspx.cs" Inherits="SIS_Student.ECT_AF_AFO_FRM_001" MasterPageFile="~/Student.Master"%>
                        ...
                        <div class="x_content">
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <th style="text-align: left; padding-left: 10px">Issue: 19/03/2015</th>
                                        <th style="text-align: right;">Revision Date: 27/04/2020</th>
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-AF-AFO-FRM.001</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p style="text-align: center; font-size: 23px; font-weight: bold;">Official Financial Letter<br />
                                               طلب افادة بالتكاليف الدراسية
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">
                                    ...
                                    <tr>
                                        <td align="center" >
                                            Receipt of the request after (3) days of submission, and this quotation is considered invalid after one month from the issue day. Non-refundable.
                                        </td>                                     
                                        <td align="center" >
                                              استلام الطلب بعد (3) ايام من تقديمه ويعتبر الطلب لاغياً في حالة عدم استلامه خلال شهر من تاريخ تقديمه ولا يحق المطالبة بالرسوم
                                        </td>
                                    </tr>                                
                                </table>
                                ...
                                <asp:HiddenField ID="hdf_ServiceDescEn" runat="server" Visible="false"/>
                                <br />
