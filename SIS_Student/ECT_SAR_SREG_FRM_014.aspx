<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SREG_FRM_014.aspx.cs" Inherits="SIS_Student.ECT_SAR_SREG_FRM_014" MasterPageFile="~/Student.Master"%>
                        ...
                        <div class="x_content">
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <th style="text-align: left; padding-left: 10px">Issue: 18/05/2011</th>
                                        <th style="text-align: right;">Revision Date: 10/06/2015</th>
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SREG-FRM.014</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                ...
                                <hr />
                                <h2 class="title" style="padding-left:50px;padding-right:50px;line-height: 1.6;">I, the undersigned, pledge to improve my GPA in the next semester up to 2.0 or more in order to achieve a good academic standing. Failing to do so, I will be dismissed from the major and I have to continue in another major.</h2>
                                <hr />
