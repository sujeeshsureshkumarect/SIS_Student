...
namespace SIS_Student
{
    public partial class ECT_SAR_SCDA_FRM_001 : System.Web.UI.Page
    {
        ...
        {            
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Nationality:</b> " + lbl_Nationality.Text + "<br/><b>Major:</b> " + lbl_CurrentMajor.Text + "<br/><b>Remarks/Notes:</b> " + txt_Remarks.Text.Trim() + "<br/>";
