<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SARO_FRM_019.aspx.cs" Inherits="SIS_Student.ECT_SAR_SARO_FRM_019" MasterPageFile="~/Student.Master"%>
                            ...
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SARO-FRM.019</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p style="text-align: center; font-size: 23px; font-weight: bold;">Petition Form<br />
                                            طلب إعادة نظر في درجات الإمتحان النهائي
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">                         
                                    <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td align="center">
                                            <asp:TextBox ID="txt_Remarks" runat="server" TextMode="MultiLine" placeholder="Enter Request details / أدخل الملاحظات" Height="100px" CssClass="form-control"></asp:TextBox>
