...
{
    public partial class ECT_SAR_SARO_FRM_001 : System.Web.UI.Page
    {
        ...
        {
            string sNatureofservice = "";
            if(chk_AcademicIssue.Checked==true)
            {
                sNatureofservice += "Academic Issue, ";
            }
            if (chk_AdministrativeIssue.Checked == true)
            {
                sNatureofservice += "Administrative Issue, ";
            }
            if (chk_FacilitiesIssue.Checked == true)
            {
                sNatureofservice += "Facilities Issue, ";
            }
            ...
            myItem["Request"] = "<b>Service ID:</b> " + lbl_ServiceID.Text + "<br/> <b>Service Name:</b> " + lbl_ServiceNameEn.Text + " (" + lbl_ServiceNameAr.Text + " )<br/><b>Nature of the service:</b> "+sNatureofservice+"<br/><b>Remarks:</b> " + txt_Remarks.Text.Trim() + "<br/>" + languageoption + "<br/>";
