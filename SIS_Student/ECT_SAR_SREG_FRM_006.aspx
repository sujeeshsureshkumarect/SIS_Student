<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ECT_SAR_SREG_FRM_006.aspx.cs" Inherits="SIS_Student.ECT_SAR_SREG_FRM_006" MasterPageFile="~/Student.Master"%>
                            ...
                            <div id="form" align="center">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        ...
                                        <th style="text-align: right; padding-right: 10px">Ref No.: ECT-SAR-SREG-FRM.006</th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                          <%--  <p style="text-align: center; font-size: 23px; font-weight: bold;">Pledge for Under Probation Student<br />
                                        تعهد خطي أول لرفع المعدل التراكمي اكثر او يساوي 2
                                            </p>--%>
                                ...
                                <hr />
                                <h2 class="title" style="padding-left:50px;padding-right:50px;line-height: 1.6;">I, the undersigned, pledge to improve my GPA in the next semester up to 2.0 or more in order to achieve a good academic standing. Failing to do so, I will be given only one more chance (Final probation).</h2>
                                <hr />
                                ...
                                <table style="width: 100%; border: 1px solid #e5e5e5" align="center" class="details">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="center">
                                            <asp:Label ID="lbl_AcademicAdvisor" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td align="center" style="background-color: #f2f2f2;">
                                            <b>المرشد الأكاديمي</b>
                                        </td>
                                    </tr>
                                </table>
                                    <hr />                         
