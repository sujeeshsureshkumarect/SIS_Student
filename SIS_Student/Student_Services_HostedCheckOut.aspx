<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student_Services_HostedCheckOut.aspx.cs" Inherits="SIS_Student.Student_Services_HostedCheckOut" MasterPageFile="~/Student.Master"%>
    ...
    <div class="right_col" role="main">
        ...
        <script type="text/javascript">
            ...
            function SetPayment(orderId, sessionId, desc, amount, resultIndicator, result) {
                ...
                if (request != null) {
                    var url = "Student_Services_HostedResult.aspx/SetPayment";
            ...
            function completeCallback(response) {
                ...
                window.location.href = "/Student_Services_HostedResult.aspx";
            }
